...
export default function Tabs() {
    ...
    const currentTab = tabs.find(tab => tab.href === location.pathname)!.href
        ...
        <div className='mb-10'>
            <div className="sm:hidden">
                ...
                <select
                    id="tabs"
                    name="tabs"
                    className="block w-full p-3 border border-gray-300 rounded-md focus:ring-1 focus:border-purple-800"
