                            ...
                            <li key={project._id} className="flex justify-between gap-x-6 px-5 py-10">
                                <div className="flex min-w-0 gap-x-4">
                                    <div className="min-w-0 flex-auto space-y-2">
                                        ...
                                        <p className="font-bold text-xs uppercase bg-purple-50 text-purple-500 border-2 border-purple-600 rounded-lg inline-block py-1 px-5">Manager</p> :
                                        <p className="font-bold text-xs uppercase bg-indigo-50 text-indigo-500 border-2 border-indigo-500 rounded-lg inline-block py-1 px-5">Colaborador</p> 
                                        ...
                                        <p className="text-sm text-gray-400">
                                         ...
                                         <p className="text-sm text-gray-700">
                                            Rol usuario: {project.manager ===  userData._id ? 'manager' : 'colaborador'}
                                        </p>
                                    </div>
                                </div>
