...
import type { UpdatePasswordForm } from "@/types/index";
      ...
      <div className="mx-auto max-w-3xl">
        ...
        >
          ...
          <div className="mb-5 space-y-3">
            ...
            <input
              ...
              {...register("password", {
                ...
                minLength: {
                  value: 8,
                  message: 'La contraseña ha de tener mínimo 8 caracteres'
                }
              })}
            />
            {errors.password && (
          ...
          <input
            ...
            className="bg-fuchsia-600 w-full p-3 text-white font-bold hover:bg-fuchsia-700 cursor-pointer transition-colors text-xl"
          />
        </form>
      </div>
    </>
