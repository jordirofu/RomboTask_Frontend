...
import AddMember from "@/components/team/AddMemberModal"
...
export default function ProjectTeamView() {
    ...
    const handleClickRemoveButton = (memberId: TeamMember['_id']) => {
    ...
    if (data) return (
        <>
            <h1 className="text-5xl font-black">Equipo de trabajo</h1>
            ...
            <h2 className="text-5xl font-black mt-20">Miembros actuales</h2>
            {data.length ? (
                                        ...
                                        <MenuItems className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
                                            <MenuItem>
                                                <button
                                                    ...
                                                    onClick={() => handleClickRemoveButton(member._id)}
                                                >
                ...
                <p className='text-center py-10'>No hay miembros en este equipo</p>
            )}
